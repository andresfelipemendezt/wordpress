        ...
        <div style="float:left;width:69%;">
            <div class="wrap">
               <table><tr><td><a href="https://twitter.com/FreeAdsPost" class="twitter-follow-button" data-show-count="false" data-size="large" data-show-screen-name="false">Follow @FreeAdsPost</a>
                ...
                <span><h3 style="color: blue;"><a target="_blank" href="http://www.my-php-scripts.net/index.php/Wordpress/wordpress-thumbnail-slider-pro-wordpress-featured-image-add-into-slider.html">Upgrade to WordPress Thumbnail Slider Pro</a></h3></span>
    ...
    <div class="clear"></div>
         ...
         <div id="poststuff" class="metabox-holder has-right-sidebar" style="float:right;width:30%;">
           <div class="postbox">
              ...
              <div class="inside">
                   <center><script type="text/javascript" src="http://www.hostmonster.com/src/js/nik00726/CODE66/300x250/hm_300x250_01.jpg"></script></center>
                    ...
                    <table class="mainTable">
                      <tr>
                        <?php if($settings['auto']==false){?>
                         ...
                         <?php } ?>
                         <td id="mainscollertd" style="">
                            <div class="mainSliderDiv">
                                <p class="captions">aja el php qué?<?php  echo $row['title'];?></p>
                                <ul class="sliderUl">
                                <p class="captions"><?php  echo $row['title'];?></p>
                                  <?php
                                      global $wpdb;
                                   ...
                                   ?>
                                    ...
                                    <li class="sliderimgLi">
                                      ...
                                      <?php if($settings['linkimage']==true){ ?>
                                        ...
                                        <a target="_blank" href="<?php if($row['custom_link']==""){echo '#';}else{echo $row['custom_link'];} ?>">
                                        <p class="captions"><?php  echo $row['title'];?></p>
                                        <img src="<?php echo $outputimg; ?>" alt="<?php echo $row['title']; ?>" title="<?php echo $row['title']; ?>" style="width:<?php echo $settings['imagewidth']; ?>px;height:<?php echo $settings['imageheight']; ?>px"  /></a>
                                      <?php }else{ ?>
        ...
        <table class="mainTable">
          <tr>
            <?php if($settings['auto']==false){?>
             ...
             <?php } ?>
             <td id="mainscollertd" style="visibility: hidden;">
                <div class="captionscontainer"></div>
                <div class="mainSliderDiv">
                    ...
                    <ul class="sliderUl">
                      <?php
                       ...
                       ?>
                        ...
                        <div class="captions"> <?php echo $row['title']; ?></div>
